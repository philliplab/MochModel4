...
```{r Run Models and create connections, eval=rerun_models}
library(foreach)
library(doSNOW)
cl <- makeCluster(6)
...
test_results <- new_test(test_results,
                         name = ctest_name,
                         scenarios = cscenarios,
                         description = "Plots of all the survival curves. The curves must be inspected manually. Only add those states that directly affect the scehduling og mortality, otherwise this plot will become to cluttered.")
```
