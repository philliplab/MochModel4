...
p <- arrangeGrob(
plot_one_vdp_cat(all_survival_data, 'vdpa1', phi = 1.22398),
plot_one_vdp_cat(all_survival_data, 'vdpa2', phi = 0.95143),
plot_one_vdp_cat(all_survival_data, 'vdpa3', phi = 0.58661),
plot_one_vdp_cat(all_survival_data, 'vdpa4', phi = 0.52447))
print(p)
result <- 'Manual'
```
